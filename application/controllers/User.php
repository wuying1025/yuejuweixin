...
//            echo "success";
    ...
    public function update_user_info()
    {
        ...
        $idcard = htmlspecialchars($this->input->post("idcard"));
        $head_img = htmlspecialchars($this->input->post("headImg"));
        $login_user = $this->session->userdata('userinfo');
        $user_id = $login_user->user_id;
        $head_img = $head_img=="" || $head_img==null?$login_user->portrait:$head_img;
